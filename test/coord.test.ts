...
describe('* coord', () => {
	...
	it('offsetCoord()', () => {
		...
		// limit, returns same
		coord = _makeCoord(CompassMax, 1, 0, 0)
		coord = _testOffset(coord, Dir.North, CompassMax, 1, 0, 0)
		...
		// limit, returns same
		coord = _makeCoord(0, 1, 0, CompassMax)
		coord = _testOffset(coord, Dir.South, 0, 1, 0, CompassMax)
		...
		// limit, returns same
		coord = _makeCoord(1, CompassMax, 0, 0)
		coord = _testOffset(coord, Dir.East, 1, CompassMax, 0, 0)
		...
		// limit, returns same
		coord = _makeCoord(1, 0, CompassMax, 0)
		coord = _testOffset(coord, Dir.West, 1, 0, CompassMax, 0)
